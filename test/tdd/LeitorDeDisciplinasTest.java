...
public class LeitorDeDisciplinasTest {
	...
	public void deveMostrarDisciplina () {
		...
		Disciplina p1 = new Disciplina("Programacao I", 4, requisitos, 5, 1);
		...
		requisitos1.add(p1);
		requisitos1.add(new Disciplina ("Int. a Computacao", 4, requisitos, 5, 1));
		requisitos1.add(new Disciplina ("Lab. de Programacao I", 4, requisitos, 5, 1));
		Disciplina p2 = new Disciplina("Programacao II", 4, requisitos1, 5, 2);
