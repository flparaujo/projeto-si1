...
public class SistemaDePlanejamentoDeCursoTest {
	...
	public void naoDeveAdicionarPeriodoAcimaDoLimite() throws LimiteDePeriodosException {
		for(int i = SistemaDePlanejamentoDeCurso.MINIMO_DE_PERIODOS; i < 
				SistemaDePlanejamentoDeCurso.MAXIMO_DE_PERIODOS; i++) {
	...
	public void deveMostrarBlocagemPadrao() {
		assertEquals(SistemaDePlanejamentoDeCurso.MINIMO_DE_PERIODOS, sistema.getPeriodos().size());
	...
	public void ultimoPeriodoNaoDeveTerLimiteDeCreditos() throws Exception {
		sistema.adicionaDisciplinaAoPeriodo(SistemaDePlanejamentoDeCurso.MINIMO_DE_PERIODOS-1, 
		...
		sistema.adicionaDisciplinaAoPeriodo(SistemaDePlanejamentoDeCurso.MINIMO_DE_PERIODOS-1, 
				"Expressao Grafica");
		assertEquals(34, sistema.numeroDeCreditosDoPeriodo(SistemaDePlanejamentoDeCurso.MINIMO_DE_PERIODOS-1));
	}
