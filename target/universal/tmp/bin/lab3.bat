@REM lab3 launcher script
@REM
@REM Envioronment:
@REM JAVA_HOME - location of a JDK home dir (optional if java on path)
@REM CFG_OPTS  - JVM options (optional)
@REM Configuration:
@REM LAB3_config.txt found in the LAB3_HOME.
@setlocal enabledelayedexpansion

@echo off
if "%LAB3_HOME%"=="" set "LAB3_HOME=%~dp0\\.."
set ERROR_CODE=0

set "APP_LIB_DIR=%LAB3_HOME%\lib\"
...
set "CFG_FILE=%LAB3_HOME%\LAB3_config.txt"
set CFG_OPTS=
if exist %CFG_FILE% (
...
if "%JAVAOK%"=="false" (
  ...
  echo and download a valid Java JDK and install before running lab3.
  echo.
